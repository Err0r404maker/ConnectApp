  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'bounce-gentle': 'bounceGentle 2s cubic-bezier(0.25, 0.46, 0.45, 0.94) infinite',
      ...
      keyframes: {
        ...
        slideUp: {
          ...
          '50%': { transform: 'translateY(-5px) scale(1.02)', opacity: '0.8', filter: 'blur(1px)' },
